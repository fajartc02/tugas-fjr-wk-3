function mengelompokkanAngka(arr) {
    ...
    for (var i = 0; i < arr.length; i++) { // looping for display all Array
      if (arr[i] % 3 === 0) { // conditional angka yang habis dibagi 3
      containArr3.push(arr[i])
      } else if (arr[i] % 2 === 0 ) { // conditional angka genap AND bukan angka yang habis dibagi 3
        containArr1.push(arr[i])
      } else if (arr[i] % 2 !== 0) { // conditional angka ganji AND tidak habis dibagi 3
